...
const SECTIONS: { title: string; body: string[] }[] = [
  ...
  },
  {
    title: "6. 개인정보의 국외 이전",
    body: [
      "회사는 서비스 제공을 위해 아래와 같이 개인정보를 국외로 이전(처리위탁)하고 있습니다(개인정보 보호법 제28조의8).",
      "· 이전받는 자: Supabase Inc. / 이전 국가: 미국 / 이전 항목: 제1항의 수집 항목 전체 / 이전 목적: 데이터베이스 보관 / 보유·이용 기간: 회원 탈퇴 또는 위탁계약 종료 시까지",
      "· 이전받는 자: Render Services, Inc. / 이전 국가: 미국 등 / 이전 항목: 서비스 처리 과정의 개인정보 / 이전 목적: 애플리케이션 서버 운영 / 보유·이용 기간: 위탁계약 종료 시까지",
      "· 이전받는 자: Vercel Inc. / 이전 국가: 미국 / 이전 항목: 접속 로그 등 / 이전 목적: 프론트엔드 호스팅·배포 / 보유·이용 기간: 위탁계약 종료 시까지",
      "· 이전 일시 및 방법: 서비스 이용 시 정보통신망을 통해 수시로 전송",
      "· 이용자는 개인정보의 국외 이전을 거부할 수 있으며, 거부 시 회원가입 및 서비스 이용이 제한될 수 있습니다. 거부는 회원 탈퇴를 통해 할 수 있습니다.",
    ],
  },
  {
    title: "7. 이용자의 권리",
