...
const SECTIONS: { title: string; body: string[] }[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "2. 만 14세 미만의 아동은 회원가입을 할 수 없으며, 회사는 만 14세 미만으로 확인된 계정의 이용을 제한하거나 삭제할 수 있습니다.",
      "3. 회원은 언제든지 마이페이지의 회원 탈퇴 기능을 통해 탈퇴할 수 있으며, 탈퇴 시 개인정보는 개인정보처리방침에 따라 지체 없이 파기 또는 익명화됩니다.",
    ],
  },
  {
    title: "제5조 (캐시 및 예약금)",
    body: [
      ...
      "3. 유상으로 충전한 캐시의 미사용 잔액은 결제일로부터 7일 이내 청약철회가 가능하며, 그 이후에도 관련 법령 및 회사가 정한 환급 절차에 따라 잔액을 환급받을 수 있습니다. 이 경우 결제수단별 환급 수수료가 발생할 수 있습니다.",
      "4. 회원 탈퇴 시 유상 충전 캐시의 잔액은 위 절차에 따라 환급을 요청할 수 있으며, 환급을 요청하지 않고 탈퇴하는 경우 미사용 잔액은 소멸될 수 있습니다.",
      "5. 현재 캐시 충전은 실제 결제 연동 없이 체험(데모) 형태로 운영될 수 있으며, 이 경우 실제 과금이 발생하지 않습니다. 정식 결제 도입 시 제3항·제4항의 환급 규정이 적용됩니다.",
      "6. 캐시의 충전·사용·환불에 관한 그 밖의 세부 사항은 서비스 내 안내에 따릅니다.",
    ],
  },
  {
