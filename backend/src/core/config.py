    ...
    PURPOSE_CONFIG = {
        "식사": {
            ...
            "tabs": {
                ...
                "VIBE": {
                    "label": "분위기",
                    # 가격[가성비·고급] · 격식[캐주얼] · 소음[조용·활기] · 무드[감성] · 공간[뷰·룸]
                    "options": ["가성비", "고급스러운", "캐주얼", "조용한", "활기찬", "감성적인", "뷰맛집", "룸/프라이빗"],
                },
            },
        },
        "술": {
            ...
            "tabs": {
                ...
                "VIBE": {
                    "label": "분위기",
                    # 가격[가성비·프리미엄] · 소음[조용·시끌] · 무드[감성] · 공간[루프탑·룸] · 특징[라이브] · 인원[혼술]
                    "options": ["가성비", "프리미엄", "조용한", "시끌벅적", "감성적인", "루프탑/야외", "룸/프라이빗", "라이브/음악", "혼술"],
                },
            },
        },
        "카페": {
            ...
            "tabs": {
                ...
                "VIBE": {
                    "label": "분위기",
                    # 무드[감성·모던] · 소음[조용] · 용도[작업] · 규모[대형] · 공간[뷰·루프탑] · 특징[반려동물]
                    "options": ["감성/예쁜", "모던/힙", "조용한", "작업/스터디", "대형/넓은", "뷰맛집", "루프탑/야외", "반려동물"],
                },
            },
        },
        "데이트": {
            ...
            "tabs": {
                ...
                "VIBE": {
                    "label": "분위기",
                    # 무드[로맨틱·감성·이색] · 소음[조용·활기] · 공간[야경뷰·프라이빗]
                    "options": ["로맨틱", "감성적인", "조용한", "활기찬", "야경/뷰", "프라이빗", "이색적인"],
                },
            },
        },
        "비즈니스": {
            ...
            "tabs": {
                "TYPE": {
                    "label": "유형",
                    # 미팅 형태
                    "options": ["식사미팅", "카페미팅", "회의실", "코워킹", "프라이빗룸", "세미나/행사"],
                },
                "VIBE": {
                    "label": "분위기",
                    # 소음[조용] · 격식[격식·캐주얼] · 공간[프라이빗] · 무드[모던] · 접근성[교통편리]
                    "options": ["조용한", "격식있는", "캐주얼", "프라이빗", "모던/깔끔", "교통편리"],
                },
            },
        },
        "문화활동": {
